...
const close_pop_up=()=>{
    ...
    useEffect(()=>{
        ...
        const Deletedata = async (id) => {
            ...
            let request_url = "http://localhost:5000/User/DeleteDoctor" ; 
            let request_opton = {
                method: "POST", 
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
  ...
  return (
    <div className='doctor_data_main' style={{color:"#388087"}}>
...
<div className="pop_up_all_details" id="fullDetails">
    ...
    <div class="col-auto m-2">
        {/* <label class="visually-hidden" for="autoSizingInputGroup">Username</label> */}
        <div class="input-group">
        <div class="input-group-text">Specialization </div>
        <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="" value={FullData.Specialization}/>
        </div>
    </div>
    <div class="col-auto m-2">
        {/* <label class="visually-hidden" for="autoSizingInputGroup">Username</label> */}
...
{/* ends  */}
    ...
    <div className='w-100 text-center mt-3'>
        <h2 style={{color:"#388087"}}>Doctors</h2>        
    </div>  
