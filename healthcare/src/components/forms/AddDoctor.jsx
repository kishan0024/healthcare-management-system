      ...
      <div className='col-md-5'>
        <div className="form-row">
          ...
          <div className="form-group col-md-12">
            ...
            <input type="text" className="form-control" id="Specialization" placeholder="Specialization"  onChange={handleInput} required/>
          </div>
        </div>
        ...
        <div className='w-100 row justify-content-center mt-2'>
          <button type="submit" className="btn btn-primary" onClick={submit_data}>Add Doctor</button>
